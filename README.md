...
**PetAuth** - это в первую очередь pet-проект, но также серверное приложение, которое фиксирует присутствие сотрудников на рабочем месте с помощью QR-кодов. Система включает в себя сервер на **Ktor**, базу данных **MongoDB**, и клиентское приложение на **Kotlin Compose**. 
